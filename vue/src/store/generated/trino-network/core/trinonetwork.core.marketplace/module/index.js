...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgDeleteNode: (data) => ({ typeUrl: "/trinonetwork.core.marketplace.MsgDeleteNode", value: data }),
        msgCreateNode: (data) => ({ typeUrl: "/trinonetwork.core.marketplace.MsgCreateNode", value: data }),
        msgUpdateNode: (data) => ({ typeUrl: "/trinonetwork.core.marketplace.MsgUpdateNode", value: data }),
    };
};
